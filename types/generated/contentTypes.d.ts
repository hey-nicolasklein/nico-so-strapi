...
export interface ApiCvEntryCvEntry extends Struct.CollectionTypeSchema {
  collectionName: 'cv_entries';
  info: {
    description: 'CV entries for education and experience';
    displayName: 'CV Entry';
    pluralName: 'cv-entries';
    singularName: 'cv-entry';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    category: Schema.Attribute.Enumeration<['education', 'experience']> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPageContentPageContent extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Main page content and settings';
  ...
  attributes: {
    ...
    heroGreeting: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"Hey I'm">;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    memojiDark: Schema.Attribute.Media<'images'>;
    memojiLight: Schema.Attribute.Media<'images'>;
    metaDescription: Schema.Attribute.Text & Schema.Attribute.Required;
    profileImage: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Nicolas'>;
    siteTitle: Schema.Attribute.String & Schema.Attribute.Required;
    taglineDesktop: Schema.Attribute.String & Schema.Attribute.Required;
    taglineMobile: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPortfolioItemPortfolioItem
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    createdWith: Schema.Attribute.String;
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['Artwork', 'Music', 'Movie', 'Other']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contactCta: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"Let's change the world together.">;
    ...
    emailBody: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Let us talk :)'>;
    emailSubject: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Hey'>;
    footerCopyright: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u00A9 {year} Nicolas Klein'>;
    footerText: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'created with'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['frontend', 'backend', 'design', 'tools', 'framework']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::cv-entry.cv-entry': ApiCvEntryCvEntry;
